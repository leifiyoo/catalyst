...
public class ProtocolVersionMapper {
    ...
    static {
        // 1.21.x
        PROTOCOL_MAP.put(776, "1.21.11");
        PROTOCOL_MAP.put(775, "1.21.10");
        PROTOCOL_MAP.put(774, "1.21.9");
        PROTOCOL_MAP.put(773, "1.21.8");
        PROTOCOL_MAP.put(772, "1.21.7");
        PROTOCOL_MAP.put(771, "1.21.6");
        PROTOCOL_MAP.put(770, "1.21.5");
        PROTOCOL_MAP.put(769, "1.21.4");
        PROTOCOL_MAP.put(768, "1.21.2/1.21.3");
        PROTOCOL_MAP.put(767, "1.21.2/1.21.3");
        PROTOCOL_MAP.put(766, "1.21/1.21.1");
        // 1.20.x
        PROTOCOL_MAP.put(765, "1.20.5/1.20.6");
        ...
        PROTOCOL_MAP.put(477, "1.14.3");
        PROTOCOL_MAP.put(480, "1.14.2");
        PROTOCOL_MAP.put(478, "1.14.1");
        PROTOCOL_MAP.put(490, "1.14");
        // 1.13.x
        PROTOCOL_MAP.put(404, "1.13.2");
        PROTOCOL_MAP.put(393, "1.13");
        // 1.12.x
        PROTOCOL_MAP.put(340, "1.12.2");
        PROTOCOL_MAP.put(316, "1.12");
        // 1.11.x
        PROTOCOL_MAP.put(315, "1.11.2");
        // 1.10.x
        PROTOCOL_MAP.put(210, "1.10.2");
        // 1.9.x
        PROTOCOL_MAP.put(110, "1.9.4");
        // 1.8.x
        PROTOCOL_MAP.put(47, "1.8.x");
    }
